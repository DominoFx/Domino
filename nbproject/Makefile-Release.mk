...
${OBJECTDIR}/LIS3DH.o: LIS3DH.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I. -I../jsoncpp -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/LIS3DH.o LIS3DH.cpp

${OBJECTDIR}/dmx/DmxController.o: dmx/DmxController.cpp
	${MKDIR} -p ${OBJECTDIR}/dmx
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I. -I../jsoncpp -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/dmx/DmxController.o dmx/DmxController.cpp
...
${OBJECTDIR}/soft_i2.o: soft_i2.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I. -I../jsoncpp -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/soft_i2.o soft_i2.cpp
