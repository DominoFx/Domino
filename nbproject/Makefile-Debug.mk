...
${OBJECTDIR}/BMA220.o: BMA220.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I. -I../jsoncpp -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/BMA220.o BMA220.cpp
...
${OBJECTDIR}/dmx/DominoParams.o: dmx/DominoParams.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -I. -I../jsoncpp -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/dmx/DominoParams.o dmx/DominoParams.cpp
	
${OBJECTDIR}/dmx/DominoState.o: dmx/DominoState.cpp
	${MKDIR} -p ${OBJECTDIR}/dmx
	${RM} "$@.d"
	$(COMPILE.cc) -g -I. -I../jsoncpp -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/dmx/DominoState.o dmx/DominoState.cpp
